...
use chained_codec::decoder::DecoderExt;
...
fn test_simple_chain() {
    let mut decoder = BitwiseNotDecoder {}.chain_decoder(StringDecoder {});
...
fn test_not_not() {
    let mut decoder = BitwiseNotDecoder {}
        .chain_decoder(BitwiseNotDecoder {})
        .chain_decoder(BitwiseNotDecoder {})
        .chain_decoder(StringDecoder {});
